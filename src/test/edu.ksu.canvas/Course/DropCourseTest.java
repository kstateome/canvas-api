...
public class DropCourseTest {
    ...
    public void testEnrollUser() throws IOException{
        ...
        Optional<Enrollment> enrollmentResponse = coursesImpl.enrollUser(token,25,78839);
    ...
    @Test
    public void dropEnrolledUser() throws IOException{
        //get user enrollments
        List<Enrollment> getEnrollments = userImpl.getUserEnrollments(token,78839);
          Optional<Enrollment> dropResponse = coursesImpl.dropUser(token, 25, 355047L);
