...
public class DropCourseUTest extends CanvasTestBase {
    ...
    public void testEnrollUser() throws IOException {
        ...
        Optional<Enrollment> enrollmentResponse = enrollmentsWriter.enrollUser(SOME_OAUTH_TOKEN,25,78839);
    ...
    public void  testDropEnrolledUser() throws IOException {
        ...
        Optional<Enrollment> dropResponse = enrollmentsWriter.dropUser(SOME_OAUTH_TOKEN, 25, 355047L);
