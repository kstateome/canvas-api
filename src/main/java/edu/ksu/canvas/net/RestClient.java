...
public interface RestClient {
    ...
    Response sendApiPostFile(@NotNull OauthToken token, @NotNull String url, Map<String, List<String>> postParameters, String fileParameter, String filePath, int connectTimeout, int readTimeout) throws InvalidOauthTokenException, IOException;
