...
public class GradingStandardImpl extends BaseImpl<GradingStandard, GradingStandardReader, GradingStandardWriter> implements GradingStandardReader, GradingStandardWriter{
    ...
    @Override
    public List<GradingStandard> listGradingStandardsInCourse(String courseId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public List<GradingStandard> listGradingStandardsInAccount(String accountId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<GradingStandard> getGradingStandardInCourse(String courseId, Long gradingStandardId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<GradingStandard> getGradingStandardInAccount(String accountId, Long gradingStandardId) throws IOException, URISyntaxException, ParseException {
