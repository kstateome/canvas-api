...
public class MigrationIssueImpl extends BaseImpl<MigrationIssue, MigrationIssueReader, CanvasWriter> implements MigrationIssueReader {
    ...
    @Override
    public List<MigrationIssue> getCourseMigrationIssues(String courseId, Long migrationId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<MigrationIssue> getCourseMigrationIssue(String courseId, Long migrationId, Long issueId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public List<MigrationIssue> getUserMigrationIssues(String userId, Long migrationId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<MigrationIssue> getUserMigrationIssue(String userId, Long migrationId, Long issueId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public List<MigrationIssue> getGroupMigrationIssues(String groupId, Long migrationId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<MigrationIssue> getGroupMigrationIssue(String groupId, Long migrationId, Long issueId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public List<MigrationIssue> getAccountMigrationIssues(String accountId, Long migrationId) throws IOException, URISyntaxException, ParseException {
    ...
    @Override
    public Optional<MigrationIssue> getAccountMigrationIssue(String accountId, Long migrationId, Long issueId) throws IOException, URISyntaxException, ParseException {
