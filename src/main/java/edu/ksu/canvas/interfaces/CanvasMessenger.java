...
public interface CanvasMessenger {
    ...
    Response sendJsonPostToCanvas(String oauthToken, String url, JsonObject requestBody) throws InvalidOauthTokenException, IOException;
    Response sendJsonPutToCanvas(String oauthToken, String url, JsonObject requestBody) throws InvalidOauthTokenException, IOException;
